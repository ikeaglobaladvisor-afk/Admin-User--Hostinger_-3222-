...
var totaluser = firebase.database().ref().child("ip_record");
var alluser = firebase.database().ref().child("ip_record");
...
var val = data.val();
     ...
     content += '<td >' + val.id_address + '</td>';

  content += '<td >' + val.browser + '</td>';
